...
- SolidJS + Vite frontend in `crates/tauri/ui/`
- `crates/tauri/src-tauri/` for Rust backend
...
**Create:** `crates/tauri/src-tauri/src/main.rs`
...
**Create:** `crates/tauri/src-tauri/src/commands/`
...
|--------|------|-------------|
| Create | `crates/tauri/` | Tauri project root |
| Create | `crates/tauri/Cargo.toml` | Rust crate config |
| Create | `crates/tauri/src-tauri/` | Tauri Rust backend |
| Create | `crates/tauri/src-tauri/src/main.rs` | Entry point + daemon lifecycle |
| Create | `crates/tauri/src-tauri/src/commands/` | IPC command handlers |
| Create | `crates/tauri/src-tauri/tauri.conf.json` | Tauri config |
| Create | `crates/tauri/ui/` | SolidJS frontend |
| Create | `crates/tauri/ui/package.json` | JS dependencies |
| Create | `crates/tauri/ui/vite.config.ts` | Vite config |
| Create | `crates/tauri/ui/src/` | SolidJS source |
...
| Action | Path | Description |
|--------|------|-------------|
| Create | `crates/tauri/ui/src/pages/` | All SolidJS pages |
| Create | `crates/tauri/ui/src/components/` | Shared UI components |
| Create | `crates/tauri/ui/src/lib/` | API client, utilities |
